...
The intercept, -1.93, represents the log odds of Donald Trump being referenced in a negative sentiment.

The exponentiated estimate for the intercept, 0.15, represents the odds of Trump being referenced in a negative sentiment.

The coefficient of *candidateHillaryClinton*, 1.15, represents the difference in log odds of having a negative seniment between Donald Trump and Hillary Clinton. 
...
The coefficient for intercept, -120.63, represents the log odds of having negative sentiment for Donald Trump, when *album_release_date* is 0. 
...
The coefficient for *candidateHillaryClinton*, 1.24, represents the difference in log odds of having negative sentiment between Donald Trump and Hillary Clinton, while accounting for *album_release_date*. 
...
The coefficient for *album_release_date*, 0.06, represents a one unit increase in *album_release_date*, increases the log odds of having negative sentiment by 0.06.
...
# Hypothesis Tests - Ask Lisa for help on how to conduct hypothesis tests
